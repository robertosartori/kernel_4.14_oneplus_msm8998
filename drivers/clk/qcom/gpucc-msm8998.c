...
static int __init gpucc_msm8998_init(void)
{
...
static int gpucc_early_msm8998_probe(struct platform_device *pdev)
{
	struct resource *res;
	struct regmap *regmap;
	struct clk *tmp;
...
static int __init gpucc_early_msm8998_init(void)
{
